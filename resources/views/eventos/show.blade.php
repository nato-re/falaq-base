...
<div class="row">
    ...
    <div class="col-md-5 mb-4">
        <div class="card shadow-sm p-3">
            ...
            <form action="{{ route('eventos.perguntas.store', $evento->id) }}" method="POST">
                ...
                <div class="mb-3">
                    <label for="texto" class="form-label text-secondary">
                        Texto da Pergunta
                    </label>
                    ...
                    <textarea
                        ...
                        id="texto"
                        rows="4"
                        class="form-control bg-dark text-white border-secondary @error('texto') border-red-500 @enderror"
                        placeholder="Digite sua dúvida ou comentário para o palestrante..."
                    >{{ old('texto') }}</textarea>

                    @error('texto')
                        <div class="text-red-500 mt-2 fw-bold">
                            {{ $message }}
                        </div>
                    @enderror
                </div>
                ...
                <button
                    type="submit"
                    class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 w-full fw-bold"
                >
                    Enviar Pergunta
                </button>
            </form>
    ...
    <div class="col-md-7">
        ...
        @forelse($perguntas as $pergunta)
            ...
            <div class="card mb-4 shadow-sm border-start border-4 border-primary p-3 rounded-md">
                <div class="card-body">
